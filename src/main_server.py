...
def parse_args():
    ...
    parser.add_argument('-H', '--host', metavar='ADDR', default=IP, help='service IP address')
    parser.add_argument('-p', '--port', metavar='PORT', default=SERVER_PORT, help='service port')
